...
public class ObjcHeaderParser 
{
	public void parse(String fileName, String headerContent, ParseContext context)
	{
		...
		for (String aLine : lines) 
		{
			...
			if (aLine.startsWith("#import")) 
			{
				...
				if (context.relationMap.containsKey(refName)) {
					...
					int fromOutDegree = aRel.getFrom().getOutDegree();
					aRel.getFrom().setOutDegree(fromOutDegree + 1);
